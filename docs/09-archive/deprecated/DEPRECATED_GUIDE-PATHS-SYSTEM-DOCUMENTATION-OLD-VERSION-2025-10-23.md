...
> **⚠️ WICHTIG (Update 22.10.2025):** Die echte Produktions-DB liegt in:  
> `C:\Users\ramon\AppData\Roaming\Electron\database\rawalite.db`  
> **NICHT** in `/db/rawalite.db` (war 0KB leer). Siehe [LESSON_FIX-DATABASE-MULTIPLE-INSTANCES-CHAOS_2025-10-22.md](../../06-lessons/sessions/LESSON_FIX-DATABASE-MULTIPLE-INSTANCES-CHAOS_2025-10-22.md)
