...
> **Erstellt:** 26.10.2025 | **Letzte Aktualisierung:** 03.11.2025 (Code-Verification Update - Database Overview validation)  
> **Status:** Reference | **Typ:** Database Overview  
...
> **Schema:** `VALIDATED_REFERENCE-DATABASE-OVERVIEW-AI_2025-10-26.md`  
> **🏗️ Migration:** docs/03-data/VALIDATED → 06-handbook/REFERENCE
...
- **KI-Verhalten:** Behandelt als verlässliche Quelle für Database-Referenzen

### **TYP-KATEGORIE:** `REFERENCE-`
- **Verwendung:** Database & data overview für KI-Navigation
- **Purpose:** KI-Database Navigation Guide

> **⚠️ CRITICAL:** [../../ROOT_VALIDATED_REGISTRY-CRITICAL-FIXES_2025-10-17.md](../../ROOT_VALIDATED_REGISTRY-CRITICAL-FIXES_2025-10-17.md) - **MANDATORY READ für Database Operations**  
> **🛡️ NEVER violate:** Field-Mapper + convertSQLQuery() - Nie hardcoded snake_case SQL

---

## 🎯 **Database-System Übersicht**

**SQLite Migration 046** mit **better-sqlite3** native bindings + **Field-Mapping System** für camelCase ↔ snake_case Transformationen.

### **Kritische Architektur-Komponenten:**
- **Database Engine:** better-sqlite3 (native C++ bindings)
- **Schema Version:** Migration 046 (verified 27.10.2025)
- **Total Tables:** 29 Tabellen (verified via database inspection)
...
## 🗄️ **Database Schema (Current State Schema Version 46)**

### **Business Entities (Production Tables - 29 total):**
```sql
-- Core Business Data
