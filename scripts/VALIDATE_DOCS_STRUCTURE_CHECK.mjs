...
const NAMING_RULES = {
  'ROOT_VALIDATED': /^ROOT_VALIDATED_[A-Z-]+_\d{4}-\d{2}-\d{2}\.md$/,
  'VALIDATED': /^VALIDATED_[A-Z-]+_\d{4}-\d{2}-\d{2}\.md$/,
  'SOLVED': /^SOLVED_[A-Z-]+_\d{4}-\d{2}-\d{2}\.md$/,
  'LESSON': /^LESSON_[A-Z-]+_\d{4}-\d{2}-\d{2}\.md$/,
  'DEPRECATED': /^DEPRECATED_[A-Z-]+_\d{4}-\d{2}-\d{2}\.md$/,
  'PLAN': /^PLAN_[A-Z-]+_\d{4}-\d{2}-\d{2}\.md$/,
  'COMPLETED': /^COMPLETED_[A-Z-]+_\d{4}-\d{2}-\d{2}\.md$/,
  'WIP': /^WIP_[A-Z-]+_\d{4}-\d{2}-\d{2}\.md$/,
  'INDEX': /^INDEX\.md$/
};
